...
export function NavItemsDark() {
    ...
    return (
        <ListContainer>
            <SignUpItem>
                <Button theme="text" text="Sign Up" className="font-bold" onClick={navigateToRegister} />
            </SignUpItem>
            <SignInItem>
                <Button theme="filled" text="Sign In" className="font-bold" onClick={() => setOpen(true)} />
                <SignIn open={open} handleClose={handleClose} />
            </SignInItem>
        </ListContainer>
    )
